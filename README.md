...
The website was designed and built during the "Practical Course Web Development".
...
In the original version #path-to-api# resolves to https://frozen-sea.herokuapp.com/api.

***
# Deployment

Information for deployment, datasource change and mail distributor changes can be found in the README_DEPLOYMENT.md: https://gitlab.lrz.de/isso/frozen-sea/blob/master/README_DEPLOYMENT.md.
